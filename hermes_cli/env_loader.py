...
def load_hermes_dotenv(
    *,
    ...
    - if HERMES_PROFILE is set, `~/.hermes/profiles/<profile>/.env`
      overrides the root file for profile-scoped gateway runs.
    ...
    profile_env = (
        home_path / "profiles" / profile_name / ".env"
    ...
    if profile_env is not None and profile_env.exists():

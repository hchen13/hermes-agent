...
def _handle_react(args, remove=False):
    ...
    try:
        ...
        runner = None
    adapter = None
    if runner is not None and effective_account_id:
        account_adapters = getattr(runner, "account_adapters", {}) or {}
        adapter = account_adapters.get((platform, effective_account_id))
    if adapter is None:

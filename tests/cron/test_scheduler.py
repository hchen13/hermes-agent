...
class TestRunJobSessionPersistence:
    ...
    def test_run_job_sets_auto_delivery_env_from_dotenv_home_channel(self, tmp_path, monkeypatch):
        ...
        class FakeAgent:
            ...
            def run_conversation(self, *args, **kwargs):
                ...
                seen["account_id"] = get_session_env("HERMES_CRON_AUTO_DELIVER_ACCOUNT_ID") or None
    ...
    def test_run_job_sets_auto_delivery_account_id_from_origin(self, tmp_path, monkeypatch):
        job = {
            "id": "test-job",
            "name": "test",
            "prompt": "hello",
        ...
        with patch("cron.scheduler._hermes_home", tmp_path), \
             patch("cron.scheduler._resolve_origin", return_value=origin), \
             patch("hermes_state.SessionDB", return_value=fake_db), \
             patch(
                 "hermes_cli.runtime_provider.resolve_runtime_provider",
                 return_value={
                ...
                seen.append(
                    {
                        ...
                        "account_id": get_session_env("HERMES_CRON_AUTO_DELIVER_ACCOUNT_ID") or None,
                    }
                )
                return {"final_response": "ok"}

...
def _prepare_chat_request_overrides(
    model: str,
    ...
    if text_verbosity and _supports_text_verbosity(model):
        overrides.setdefault("verbosity", text_verbosity)
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        overrides = _prepare_chat_request_overrides(
            model,
